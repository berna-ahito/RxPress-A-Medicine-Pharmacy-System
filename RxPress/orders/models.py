...
class Order(models.Model):
    ...
    cart = models.ForeignKey(Cart, on_delete=models.CASCADE, null=True, blank=True)  # Link order to cart
    ...
    # Add methods or properties to calculate the total cost if needed
